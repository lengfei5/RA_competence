...
#                    )
# 
# saveRDS(icMat, file = paste0(outDir, 'tradeSeqDE_evaluateK_res_k3.12_100genes_v3.rds'))
# 
# toc()

## 32 cores and high memory 500G/300G for 10-20 minutes
BPPARAM <- BiocParallel::bpparam()
BPPARAM # lists current options
BPPARAM$workers <- 32 # use 2 cores
...
save(sce, counts, index_sub, file = paste0(outDir, 'tradeSeqDE_fitGAM_output_cellnb.', nb_cells, '.Rdata'))
